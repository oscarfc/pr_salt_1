...
public class DbConfigurator {
    ...
    public static final String MARIADB_USR = "salt";
    public static final String MARIADB_USER_PWD = "salt";
    public static final String MARIADB_DATABASE_NAME = "salt";
    public static final String MARIADB_CLASS_NAME = "org.mariadb.jdbc.MariaDbDataSource";
    public static final String DS_JNDI_NAME = "java:global/jdbc/salt";
